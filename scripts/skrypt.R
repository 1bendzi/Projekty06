...
#zale�nie od preferencji wybrac mozna terms jak i terms znalezione przez nas, gdy� jest ona bardziej wiarygodna
...
#podzia� obiekt�w na skupienia przy zadanej liczbie klas - metoda hierarchiczna
#eksperyment 5
